...
TORCH_HOME = f'{MAIN_DIR}/data/torch_models'# where ImageNet's pretrained models (resnet50/resnet18) weights are stored, locally on your machine
GLOVE_DIR = f'{MAIN_DIR}/data/glove' # where GloVe vectors (`glove.840B.300d.txt.pt`) are stored, locally on your machine
...
# FashionIQ
FASHIONIQ_IMAGE_DIR = f'{DATA_DIR}/fashionIQ/images'
FASHIONIQ_ANNOTATION_DIR = f'{DATA_DIR}/fashionIQ'
