...
from config import CKPT_DIR, HEATMAP_DIR, MAIN_DIR, RANKING_DIR, VOCAB_DIR
...
parser.add_argument('--image_feature_dir', default=os.path.join(MAIN_DIR, "data", "cirr", "patch_feat_res152"))
parser.add_argument('--annotation_dir', default=os.path.join(MAIN_DIR, "data", "cirr"))
...
## Concept Net
parser.add_argument('--concept_depth', default=4, type=int, help='Depth of concept net.')
parser.add_argument('--concept_heads', default=8, type=int, help='Number of heads of concept net.')
## Program Engine
parser.add_argument('--engine_depth', default=1, type=int, help='Depth of program engine.')
parser.add_argument('--num_type_instruction', default=5, type=int, help='Number of types of instructions.')
parser.add_argument('--num_instruction_generator_fc_layer', default=1, type=int, help='Number of fc layer in instruction generator.')
parser.add_argument('--num_parameter_generator_fc_layer', default=1, type=int, help='Number of fc layer in parameter generator.')
parser.add_argument('--module_depth', default=3, type=int, help='Depth of executor module.')
parser.add_argument('--module_heads', default=8, type=int, help='Number of heads of executor module.')
parser.add_argument('--module_dim_head', default=64, type=int, help='Dimension of heads of executor module.')
